...
An application represents a registered client — such as a web app, mobile app, admin — consuming the gateway. Applications can be associated with consumers to track and control which clients are authorized to interact with the gateway.
