...
description: Generate or update a Supertest HTTP API test file for a Node.js Express
  route. Use when the user wants API endpoint tests for an open route file, a selection,
  or a src/routes path.
---
