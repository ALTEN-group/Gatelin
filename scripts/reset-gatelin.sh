...
GATELIN_IMAGE="gatelin:${NODE_ENV}"
docker rmi -f "$GATELIN_IMAGE" 2>/dev/null && echo -e "${GREEN}✓${NC} Removed image: $GATELIN_IMAGE" || echo -e "${YELLOW}⚠${NC}  Image $GATELIN_IMAGE not found"
