...
/**
 * Browser-facing base for the mock workflow pages (behind Traefik: /api/pwd/web).
 * @returns {string}
 */
function publicBase() {
  return (
    process.env.WEB_PUBLIC_BASE_URL || "http://localhost:8100/api/pwd/web"
  ).replace(/\/$/, "");
}
 ...
 * gate-login-challenges / redeem-login-ticket middlewares run end to end locally.
 *
...
export function mountChallenges(app) {
  ...
  app.post("/pwd/challenges", (req, res) => {
  ...
  app.post("/pwd/trusted-devices/verify", (req, res) => {
  ...
  app.post("/pwd/login-tickets/redeem", (req, res) => {
    sweep(tickets);
  ...
  app.get("/pwd/web/2fa/verify", (req, res) => {
  ...
  app.post("/pwd/web/2fa/verify", (req, res) => {
  ...
  app.get("/pwd/web/trusted-devices/prompt", (req, res) => {
  ...
  app.post("/pwd/web/trusted-devices/prompt", (req, res) => {
  ...
  app.get("/pwd/web/password/expired", (req, res) => {
  ...
  app.post("/pwd/web/password/expired", (req, res) => {
