...
export const mockRoles = [
  {
    ...
    permissions: [
      ...
      { route: 42, operations: [12], tables: ["routes", "consumers", "services", "resources", "operations", "cors"] }, // syncPreferences

      // Users
      { route: 43, operations: [1] },  // getBasicUserInfo
      { route: 44, operations: [2] },  // getUserPreferences
      { route: 45, operations: [12], tables: ["users"] }, // syncUserPreferences

      // Roles
      { route: 46, operations: [2] },  // searchRoles
      { route: 47, operations: [2] },  // getRolePreferences
      { route: 48, operations: [12], tables: ["roles"] }, // syncRolePreferences
    ],
  ...
  },
  {
    ...
    permissions: [
      ...
      { route: 39, operations: [7], fields: ["routeId", "value"] }, // addScopes - no locked
      { route: 40, operations: [9] }, // archiveScopes
  ...
  },
  {
    ...
    permissions: [
      ...
      { route: 36, operations: [2], fields: ["id", "routeId", "value"] }, // searchScopes
