...
export const ROUTES = [
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/routes/routes.component").then((m) => m.RoutesComponent),
        title: "Routes",
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/consumers/consumers.component").then((m) => m.ConsumersComponent),
        title: "Consumers",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/services/services.component").then((m) => m.ServicesComponent),
        title: "Services",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/resources/resources.component").then((m) => m.ResourcesComponent),
        title: "Resources",
        canActivate: [aclGuard()],
        data: {
    ...
    {
        path: AppPaths.CORS,
        loadComponent: () => import("./admin/features/cors/cors.component").then((m) => m.CorsComponent),
        title: "CORS",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/operations/operations.component").then((m) => m.OperationsComponent),
        title: "Operations",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/methods/methods.component").then((m) => m.MethodsComponent),
        title: "Methods",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/fields/fields.component").then((m) => m.FieldsComponent),
        title: "Fields",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/scopes/scopes.component").then((m) => m.ScopesComponent),
        title: "Scopes",
        canActivate: [aclGuard()],
        data: {
    ...
    {
        path: AppPaths.ROLES,
        loadComponent: () => import("./admin/features/roles/roles.component").then((m) => m.RolesComponent),
        title: "Roles",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/applications/applications.component").then((m) => m.ApplicationsComponent),
        title: "Applications",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/conditions/conditions.component").then((m) => m.ConditionsComponent),
        title: "Conditions",
        canActivate: [aclGuard()],
        data: {
    ...
    },
    {
        ...
        loadComponent: () => import("./admin/features/permissions/permissions-tree.component").then((m) => m.PermissionsTreeComponent),
