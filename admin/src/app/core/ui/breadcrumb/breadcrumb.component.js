...
let BreadcrumbComponent = class BreadcrumbComponent {
    constructor() {
        ...
        this.events$ = this.router.events.pipe(filter((event) => event instanceof NavigationEnd), distinctUntilChanged());
        this.breadcrumbs$ = this.events$.pipe(map(() => this.buildBreadCrumb(this.activatedRoute.root)));
        this.breadcrumbs = toSignal(this.breadcrumbs$, {
            initialValue: [],
        });
    }
    /**
