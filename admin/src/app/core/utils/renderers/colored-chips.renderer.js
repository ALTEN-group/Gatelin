 ...
 */
export function buildColoredChipCellRenderer(sanitizer, lookup) {
    return (cellValue) => {
 ...
 */
export function buildColoredChipsCellRenderer(sanitizer, lookup) {
    return (cellValue) => {
...
//# sourceMappingURL=colored-chips.renderer.js.map