export const CRUD_LABELS_CONFIG = {
    checkbox: {
        no: "No",
        yes: "Yes",
    },
    tableRegular: {
        currentPageReport: (first, last, totalRecords) => `Showing ${first} to ${last} of ${totalRecords} records`,
    },
    archivedConfig: {
        label: "Archived",
        labelAt: "Archived at",
    ...
    validators: {
        ...
        minlength: "The entered value is too short ({requiredLength} characters minimum)",
        maxlength: "The entered value is too long ({requiredLength} characters maximum)",
...
//# sourceMappingURL=crud-labels.js.map