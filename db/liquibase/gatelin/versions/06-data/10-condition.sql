...
INSERT INTO conditions (name, "fieldId", op, value, color, core, "creatorId", "creatorName") VALUES
  ('Non-archived only', 7,  '=', 'false', '#6366F1', true, -1, 'system'),
  ('Non-core only',     22, '=', 'false', '#8B5CF6', true, -1, 'system')
