...
(1, 58,  ARRAY[2,3], NULL, NULL, -1, 'system'), -- searchConditions        → list + export
(1, 59,  ARRAY[2], NULL, NULL, -1, 'system'),   -- getConditionHistory     → list
(1, 60,  ARRAY[5], NULL, NULL, -1, 'system'),   -- updateConditions        → bulk update
(1, 61,  ARRAY[7], NULL, NULL, -1, 'system'),   -- addConditions           → bulk create
(1, 62,  ARRAY[9], NULL, NULL, -1, 'system'),   -- archiveConditions       → bulk archive
(1, 63,  ARRAY[2], NULL, NULL, -1, 'system'),   -- getPreferences          → list
(1, 64,  ARRAY[12], NULL, NULL, -1, 'system'),  -- syncPreferences         → bulk sync
(1, 65,  ARRAY[1], NULL, NULL, -1, 'system'),   -- getBasicUserInfo        → read
...
(2, 58,  ARRAY[2,3], NULL, NULL, -1, 'system'), -- searchConditions
...
(2, 62,  ARRAY[9], NULL, NULL, -1, 'system'),   -- archiveConditions
(2, 63,  ARRAY[2], NULL, NULL, -1, 'system'),   -- getPreferences
(2, 64,  ARRAY[12], NULL, NULL, -1, 'system'),  -- syncPreferences
(2, 65,  ARRAY[1], NULL, NULL, -1, 'system'),   -- getBasicUserInfo
