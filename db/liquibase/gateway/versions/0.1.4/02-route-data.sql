...
(9, 6,  '/(?<tableName>[a-zA-Z0-9_-]+)', 'addPreferences',    'Add preferences for the authenticated user and a given table',    ARRAY['POST', 'OPTIONS']::method[], true, true, -1, 'system'),
(9, 4,  '/(?<tableName>[a-zA-Z0-9_-]+)', 'updatePreferences', 'Update preferences for the authenticated user and a given table', ARRAY['PUT', 'OPTIONS']::method[], true, true, -1, 'system'),
-- users
