...
(3, 2, E'/(?<id>\d+)/history', 'getRouteHistory', 'Manage route history', ARRAY['GET', 'OPTIONS']::method[], true, true, -1, 'system'),
...
(4, 2, E'/(?<id>\d+)/history', 'getServiceHistory', 'Manage service history', ARRAY['GET', 'OPTIONS']::method[], true, true, -1, 'system'),
...
(5, 2, E'/(?<id>\d+)/history', 'getResourceHistory', 'Manage resources history', ARRAY['GET', 'OPTIONS']::method[], true, true, -1, 'system'),
...
(6, 2, E'/(?<id>\d+)/history', 'getOperationHistory', 'Manage operations history', ARRAY['GET', 'OPTIONS']::method[], true, true, -1, 'system'),
...
(7, 2, E'/(?<id>\d+)/history', 'getCorsHistory', 'Manage cors history', ARRAY['GET', 'OPTIONS']::method[], true, true, -1, 'system'),
