...
-- fields
(8, 2, '/search',             'searchFields',    'Search fields',        ARRAY['POST', 'OPTIONS']::method[], true, true, -1, 'system'),
(8, 2, '/(?<id>\d+)/history', 'getFieldHistory',  'Manage field history',  ARRAY['GET',  'OPTIONS']::method[], true, true, -1, 'system'),
