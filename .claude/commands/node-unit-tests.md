...
description: Generate or update a Jest unit test file for a Node.js module (services,
  utils, controllers, middlewares). Use when the user wants isolated unit tests for
  an open file, a selection, or a src/ path.
---
