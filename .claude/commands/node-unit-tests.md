...
description: Generate or update a Jest test file for a Node.js module (unit tests,
  or HTTP API tests for routes). Use when the user wants tests for an open file, a
  selection, or a src/ path.
---
